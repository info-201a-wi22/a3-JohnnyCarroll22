...
In order to prove that this is a state wide issue I plotted the number of African American Inmates over time for two major CA counties.  This plot shows that the number of black inmates follows a similar pattern in San Mateo and San Diego counties.  It is also important to note that the population of San Diego County is greater than that of San Mateo thus comparing the total number of inmates would not help identify any trends.

`r fig`

### Comparing Variables

This plot compares the number of white people in a population vs the number of white people in prison.  This plot shows that white people face a lower likelyhood of going to prison than that of African Americans.  The chart shows that roughly 1000 white inmates are heald for every half a million white people.  This proportion is much higher for African Americans.
